...
class ResponseAgent:
    def __init__(self):
        self.prompt = ChatPromptTemplate.from_template(
            ...
            Если нет правильного варианта ответа или варианты ответа на предоставлены то ответ будет null
            Ответ формулируй на русском языке, будь краток и точен.
            Формат вывода ответа на вопрос:
            answer: ...
            reasoning: Причины выбора конкретного варианта ответа, а также информация о языковой модели, которая выбирала ответ
